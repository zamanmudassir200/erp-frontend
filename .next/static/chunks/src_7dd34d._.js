(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_7dd34d._.js", {
        ...
        "EditEmployee.useEffect": ()=>{
            ...
            const fetchEmployee = {
                "EditEmployee.useEffect.fetchEmployee": async ()=>{
                    try {
                        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiURL$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["url"]}/employee/${id}`);
                        if (!response.ok) {
...
//# sourceMappingURL=src_7dd34d._.js.map