(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_ccf5d6._.js", {
...
const loginAdmin = async (credentials)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiURL$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["url"]}/login`, credentials);
    if (response.status !== 200) throw new Error("Login failed");
    return response.data;
};
...
function LoginPage() {
    ...
    const { trigger: login, isMutating: isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$mutation$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('login', {
        "LoginPage.useSWRMutation": async (_, { arg })=>{
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginClient"])(arg);
                // Store tokens
                if (data.accessToken) {
...
_s(LoginPage, "QEQ5wuy2pYCgjRzHGppC3iWYYi4=", false, function() {
    return [
...
//# sourceMappingURL=src_ccf5d6._.js.map