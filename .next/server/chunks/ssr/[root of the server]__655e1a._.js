...
function EditEmployee() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchEmployee = async ()=>{
            try {
                const response = await fetch(`http://localhost:3000/v1/GetEmployeByiD/getemployee/${id}`);
                if (!response.ok) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiURL$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["url"]}/v1/employe/employee/${id}`, {
                method: "PUT",
                headers: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__655e1a._.js.map