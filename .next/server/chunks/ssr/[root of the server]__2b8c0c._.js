...
function LoginPage() {
    ...
    // Login mutation
    const { trigger: loginForm, isMutating: isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$mutation$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiURL$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["url"]}/login`, async (_, { arg })=>{
        try {
            const { name, password } = arg; // Destructure name and password from arg
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"])(name, password); // Pass them as arguments to the login function
            ...
            } else if (greeting === "hr" || greeting === 'sales' || greeting === 'accounts' || greeting === 'driver') {
