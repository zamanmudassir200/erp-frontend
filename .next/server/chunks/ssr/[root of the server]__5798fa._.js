...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/services/authService.ts [app-rsc] (ecmascript)");
;
;
;
;
...
function LoginForm() {
    ...
    const handleLogin = async (e)=>{
        e.preventDefault();
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["loginService"])({
                name,
                password
            });
            if (response.success) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5798fa._.js.map