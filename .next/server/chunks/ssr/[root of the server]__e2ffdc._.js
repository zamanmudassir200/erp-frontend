...
function LoginPage() {
    ...
    // Login mutation
    const { trigger: loginForm, isMutating: isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$mutation$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])('login', async (_, { arg })=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"])(arg);
            // Store tokens
            if (data.accessToken) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e2ffdc._.js.map